...
import { CurrentFoodRoomsResponseDto } from './dto/current-food-rooms-response.dto';
import { FoodResult } from './entities/food-result.entity';
import { listResponseDto } from './dto/list-response.dto';
import { Restaurant } from './entities/restaurant.entity';
import { userResponseDto } from './dto/user-list-response.dto';
...
export class RestaurantService {
  ...
  async getCurrentRooms(): Promise<CurrentFoodRoomsResponseDto[]> {
  ...
  async getRestaurantList(): Promise<listResponseDto[]> {
  ...
  async getUserInRoom(id: string): Promise<userResponseDto[]> {
